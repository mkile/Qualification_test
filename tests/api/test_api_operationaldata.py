...
@allure.feature('API Operational Data')
class ParametrizedIndicators:

    def test_op_data_indicators(self, url_api_operational_data, indicator):
    ...
    def test_op_data_from(self, url_api_operational_data, indicator, parameter, random_number_upto_30):
    ...
    def test_op_data_to(self, url_api_operational_data, indicator, parameter, random_number_upto_30):
